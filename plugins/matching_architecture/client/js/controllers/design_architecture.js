...
angular.module('eb').controller('EBMatchingArchitectureDesignArchitectureController', function EBMatchingArchitectureDesignArchitectureController($scope, $timeout, $state, $stateParams, EBArchitectureService, EBLoaderService)
{
